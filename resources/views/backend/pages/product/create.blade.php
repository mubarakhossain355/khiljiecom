                ...
                <div class="card-body">
                    <form action="{{route('product.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" name="name" class="form-control @error('name')is-invalid @enderror" id="exampleFormControlInput1" placeholder="Product name">
                                 @error('name')
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="number" name="product_price" min="0" class="form-control @error('product_price')is-invalid @enderror" id="exampleFormControlInput1" placeholder="Product product price">
                                 @error('product_price')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{$message}}</strong>
                                    </span>
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="text" name="product_code" class="form-control @error('product_code')is-invalid @enderror" id="exampleFormControlInput1" placeholder="Enter Unique Product Code">
                                 @error('product_code')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{$message}}</strong>
                                    </span>
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="number" name="product_stock" min="1" class="form-control @error('product_stock')is-invalid @enderror" id="exampleFormControlInput1" placeholder="Product product stock">
                                 @error('product_stock')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{$message}}</strong>
                                    </span>
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="number" name="alert_quantity" min="1" class="form-control @error('alert_quantity')is-invalid @enderror" id="exampleFormControlInput1" placeholder="Product alert quantity">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="file" name="product_image" class="form-control dropify @error('product_image')is-invalid @enderror" id="exampleFormControlInput1" placeholder="category image">
                                 @error('product_image')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{$message}}</strong>
                                    </span>
