                ...
                <div class="card-body">
                    <form action="{{route('category.update',$category->slug)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" name="category_image" data-default-file="{{asset('uploads/categories')}}/{{$category->category_image}}" class="form-control dropify @error('category_image')is-invalid @enderror" id="exampleFormControlInput1" placeholder="client designation">
